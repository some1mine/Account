...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        // when
        TransactionDto transactionDto = transactionService.useBalance(1L, "10000000000", USE_AMOUNT);
    ...
    void successCancelBalance() {
        ...
        // when
        TransactionDto transactionDto = transactionService.cancelBalance("transactionId", "10000000000", CANCEL_AMOUNT);
    ...
    void cancelTransactionTransactionAccountUnMatch() {
        ...
        // when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("transactionId", "10000000012", CANCEL_AMOUNT));
